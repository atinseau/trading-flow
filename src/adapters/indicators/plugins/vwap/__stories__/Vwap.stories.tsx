...
function build(fixture: typeof fixtureBullish) {
  ...
  return {
    ...
    indicators: [
      {
        id: vwapPlugin.id,
        plugin: vwapPlugin as typeof vwapPlugin & {
          renderConfig: NonNullable<typeof vwapPlugin.renderConfig>;
        },
        // biome-ignore lint/suspicious/noExplicitAny: bypass strict Candle typing for fixture
        contribution: vwapPlugin.computeSeries(candlesForCompute as any),
      },
    ],
  };
}

export default { title: "Plugins/VWAP", component: TradingViewChart };
