...
function build(fixture: typeof fixtureBullish) {
  ...
  return {
    ...
    indicators: [
      {
        id: atrPlugin.id,
        plugin: atrPlugin as typeof atrPlugin & {
          renderConfig: NonNullable<typeof atrPlugin.renderConfig>;
        },
        // biome-ignore lint/suspicious/noExplicitAny: bypass strict Candle typing for fixture
        contribution: atrPlugin.computeSeries(candlesForCompute as any),
      },
    ],
  };
}

export default { title: "Plugins/ATR", component: TradingViewChart };
