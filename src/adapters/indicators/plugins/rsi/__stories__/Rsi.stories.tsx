...
function build(fixture: typeof fixtureBullish) {
  ...
  return {
    ...
    indicators: [
      {
        id: rsiPlugin.id,
        plugin: rsiPlugin as typeof rsiPlugin & {
          renderConfig: NonNullable<typeof rsiPlugin.renderConfig>;
        },
        // biome-ignore lint/suspicious/noExplicitAny: bypass strict Candle typing for fixture
        contribution: rsiPlugin.computeSeries(candlesForCompute as any),
      },
    ],
  };
}

export default { title: "Plugins/RSI", component: TradingViewChart };
