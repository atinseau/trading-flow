...
function build(fixture: typeof fixtureBullish) {
  ...
  return {
    ...
    indicators: [
      {
        id: bollingerPlugin.id,
        plugin: bollingerPlugin as typeof bollingerPlugin & {
          renderConfig: NonNullable<typeof bollingerPlugin.renderConfig>;
        },
        // biome-ignore lint/suspicious/noExplicitAny: bypass strict Candle typing for fixture
        contribution: bollingerPlugin.computeSeries(candlesForCompute as any),
      },
    ],
  };
}

export default { title: "Plugins/Bollinger", component: TradingViewChart };
