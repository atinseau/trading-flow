...
function build(fixture: typeof fixtureBullish) {
  ...
  return {
    ...
    indicators: [
      {
        id: volumePlugin.id,
        plugin: volumePlugin as typeof volumePlugin & {
          renderConfig: NonNullable<typeof volumePlugin.renderConfig>;
        },
        // biome-ignore lint/suspicious/noExplicitAny: bypass strict Candle typing for fixture
        contribution: volumePlugin.computeSeries(candlesForCompute as any),
      },
    ],
  };
}

export default { title: "Plugins/Volume", component: TradingViewChart };
